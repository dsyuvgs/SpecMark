...
> 分类规则参考 ISO 25010（软件质量模型）的功能适用性/性能效率/可用性维度划分，PRD检查规则参考 ISTQB 测试标准中的缺陷分类体系。详见 [knowledge/📚知识库-反馈分类规则.md](knowledge/📚知识库-反馈分类规则.md)。
...
**Q：优先级准确率还能提升吗？**
A：规则引擎纯关键词匹配的优先级准确率75.1%，加上LLM兜底后综合优先级准确率97.2%。规则引擎的主要瓶颈是中→高的漏判。改进方向：①扩充核心功能关键词库，②增加品类专属规则，③用更多真实数据优化few-shot样本。
